...
func request_EchoService_Echo_0(ctx context.Context, marshaler runtime.Marshaler, client EchoService, req *http.Request, pathParams map[string]string) (proto.Message, error) {
...
func request_EchoService_Echo_1(ctx context.Context, marshaler runtime.Marshaler, client EchoService, req *http.Request, pathParams map[string]string) (proto.Message, error) {
	var protoReq SimpleMessage
	...
	if !ok {
		return nil, status.Errorf(codes.InvalidArgument, "missing parameter %s", "num")
	}

	protoReq.Num, err = runtime.Int64(val)

	if err != nil {
		return nil, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "num", err)
	}
...
func request_EchoService_Echo_2(ctx context.Context, marshaler runtime.Marshaler, client EchoService, req *http.Request, pathParams map[string]string) (proto.Message, error) {
	var protoReq SimpleMessage
	...
	if !ok {
		return nil, status.Errorf(codes.InvalidArgument, "missing parameter %s", "lang")
	}

	if protoReq.Code == nil {
		protoReq.Code = &SimpleMessage_Lang{}
	} else if _, ok := protoReq.Code.(*SimpleMessage_Lang); !ok {
		return nil, status.Errorf(codes.InvalidArgument, "expect type: *SimpleMessage_Lang, but: %t\n", protoReq.Code)
	}
	protoReq.Code.(*SimpleMessage_Lang).Lang, err = runtime.String(val)

	if err != nil {
		return nil, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "lang", err)
	}
...
func request_EchoService_Echo_3(ctx context.Context, marshaler runtime.Marshaler, client EchoService, req *http.Request, pathParams map[string]string) (proto.Message, error) {
	var protoReq SimpleMessage
	...
	if !ok {
		return nil, status.Errorf(codes.InvalidArgument, "missing parameter %s", "line_num")
	}

	if protoReq.Code == nil {
		protoReq.Code = &SimpleMessage_LineNum{}
	} else if _, ok := protoReq.Code.(*SimpleMessage_LineNum); !ok {
		return nil, status.Errorf(codes.InvalidArgument, "expect type: *SimpleMessage_LineNum, but: %t\n", protoReq.Code)
	}
	protoReq.Code.(*SimpleMessage_LineNum).LineNum, err = runtime.Int64(val)

	if err != nil {
		return nil, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "line_num", err)
	}

	val, ok = pathParams["status.note"]
	if !ok {
		return nil, status.Errorf(codes.InvalidArgument, "missing parameter %s", "status.note")
	}

	err = runtime.PopulateFieldFromPath(&protoReq, "status.note", val)

	if err != nil {
		return nil, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "status.note", err)
	}
...
func request_EchoService_Echo_4(ctx context.Context, marshaler runtime.Marshaler, client EchoService, req *http.Request, pathParams map[string]string) (proto.Message, error) {
	var protoReq SimpleMessage
	...
	if !ok {
		return nil, status.Errorf(codes.InvalidArgument, "missing parameter %s", "no.note")
	}

	err = runtime.PopulateFieldFromPath(&protoReq, "no.note", val)

	if err != nil {
		return nil, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "no.note", err)
	}
...
func request_EchoService_EchoBody_0(ctx context.Context, marshaler runtime.Marshaler, client EchoService, req *http.Request, pathParams map[string]string) (proto.Message, error) {
	var protoReq SimpleMessage
	...
	msg, err := client.EchoBody(ctx, &protoReq)
	return msg, err
...
func request_EchoService_EchoDelete_0(ctx context.Context, marshaler runtime.Marshaler, client EchoService, req *http.Request, pathParams map[string]string) (proto.Message, error) {
	var protoReq SimpleMessage
	...
	msg, err := client.EchoDelete(ctx, &protoReq)
	return msg, err
...
// RegisterEchoServiceHandlerService registers the http handlers for service EchoService
// to "mux". The handlers forward requests to the micro service endpoint over the given implementation of "EchoService".
func RegisterEchoServiceHandlerService(ctx context.Context, mux *runtime.ServeMux, client EchoService) error {
	...
	mux.Handle("POST", pattern_EchoService_Echo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, err := request_EchoService_Echo_0(rctx, inboundMarshaler, client, req, pathParams)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_EchoService_Echo_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, err := request_EchoService_Echo_1(rctx, inboundMarshaler, client, req, pathParams)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_EchoService_Echo_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, err := request_EchoService_Echo_2(rctx, inboundMarshaler, client, req, pathParams)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_EchoService_Echo_3, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, err := request_EchoService_Echo_3(rctx, inboundMarshaler, client, req, pathParams)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_EchoService_Echo_4, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, err := request_EchoService_Echo_4(rctx, inboundMarshaler, client, req, pathParams)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_EchoService_EchoBody_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, err := request_EchoService_EchoBody_0(rctx, inboundMarshaler, client, req, pathParams)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_EchoService_EchoDelete_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, err := request_EchoService_EchoDelete_0(rctx, inboundMarshaler, client, req, pathParams)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
