...
func (*Wrappers) Descriptor() ([]byte, []int) {
	return fileDescriptor_wrappers_96f1a571c8bbd99d, []int{0}
}
...
func init() {
	proto.RegisterFile("examples/proto/examplepb/wrappers.proto", fileDescriptor_wrappers_96f1a571c8bbd99d)
}

var fileDescriptor_wrappers_96f1a571c8bbd99d = []byte{
