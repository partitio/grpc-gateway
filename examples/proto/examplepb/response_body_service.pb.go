...
func (*ResponseBodyIn) Descriptor() ([]byte, []int) {
	return fileDescriptor_response_body_service_59c69de765f7afcb, []int{0}
}
...
func (*ResponseBodyOut) Descriptor() ([]byte, []int) {
	return fileDescriptor_response_body_service_59c69de765f7afcb, []int{1}
}
...
func (*ResponseBodyOut_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_response_body_service_59c69de765f7afcb, []int{1, 0}
}
...
func init() {
	proto.RegisterFile("examples/proto/examplepb/response_body_service.proto", fileDescriptor_response_body_service_59c69de765f7afcb)
}

var fileDescriptor_response_body_service_59c69de765f7afcb = []byte{
